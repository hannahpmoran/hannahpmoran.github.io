...
function Info() {
    return (
        ...
        <div style = {{ alignItems: 'flex-start', height: '40%',  textAlign: 'right',  top: '0', paddingTop: '0px', paddingLeft: '20%', paddingRight: '10px', right: '0'}}>
                ...
                <li style = {{marginBottom: '10px', fontSize: '30px'}} ><b>CONTACT</b></li>
                    <li style = {{marginBottom: '10px'}} ><a href = 'https://www.linkedin.com/in/hannah-p-moran/'>Linkedin ↗</a></li>
                    <li style = {{marginBottom: '10px'}} ><a href = 'https://www.behance.net/hannahmoran4/'>Behance ↗</a></li>
                ...
                <ul style = {{textAlign: 'right', listStyleType: 'none', paddingRight: '10px', paddingLeft: '40%'}} >
                    <li style = {{marginBottom: '10px', fontSize: '30px'}} ><b>ABOUT</b></li>
                    ...
                    <li style = {{marginBottom: '10px'}} >My interest in UI/UX design began when I first joined my college's <a style = {{fontWeight: 'bold'}} href = "https://carleton.hack4impact.org/" > Hack4Impact</a> chapter.
