...
// import images
import fit from '../Images/drawing.png';
...
function About() {
    return (
        ...
        <img style = {{position: 'absolute', right: '0', padding: '100px', width: '15%', opacity: '0.2', zIndex: '-1'}} src = {fit} ></img>

        <div style={{ textAlign: 'right', alignItems: 'flex-start', left: '200px' }} >
            <h1 style = {{padding: '10px' }}><a style = {{color: 'blue'}} href = 'about'>about me</a></h1>
